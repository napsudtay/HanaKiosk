...
def readCard():
    ...
    # PHOTO
    photo = []
    photo.append(getData(CMD_PHOTO1))
    photo.append(getData(CMD_PHOTO2))
    photo.append(getData(CMD_PHOTO3))
    photo.append(getData(CMD_PHOTO4))
    photo.append(getData(CMD_PHOTO5))
    photo.append(getData(CMD_PHOTO6))
    photo.append(getData(CMD_PHOTO7))
    photo.append(getData(CMD_PHOTO8))
    photo.append(getData(CMD_PHOTO9))
    photo.append(getData(CMD_PHOTO10))
    photo.append(getData(CMD_PHOTO11))
    photo.append(getData(CMD_PHOTO12))
    photo.append(getData(CMD_PHOTO13))
    photo.append(getData(CMD_PHOTO14))
    photo.append(getData(CMD_PHOTO15))
    photo.append(getData(CMD_PHOTO16))
    photo.append(getData(CMD_PHOTO17))
    photo.append(getData(CMD_PHOTO18))
    photo.append(getData(CMD_PHOTO19))
    photo.append(getData(CMD_PHOTO20))

    photoMix = []  
    for index, photoarr in enumerate(photo, start=0):
        photoMix += photoarr[0]

    data = toHexString(photoMix)
