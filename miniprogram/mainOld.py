        ...
        # {"method": "readCard","id_customer": "1"}
            ...
            try:
                ...
                if (dataReadFromIdCardReader != False):  # ถ้าอ่านการ์ดได้
                    ...
                    subprocess.call([r'C:\Users\Shiba-PC\Documents\miniprogram\sound\sound_lookCam.bat'])

                elif(dataReadFromIdCardReader == False):  # ถ้าไม่สามารถอ่านการ์ดได้
                    print ('                           ', end="\r")
                    print ('          Waiting for Card...', end="\r")
                    if(checkSound == False):
                        subprocess.call([r'C:\Users\Shiba-PC\Documents\miniprogram\sound\sound_waitCard.bat'])
                        checkSound = True
        
            except:
                print("Error 0 Not Found Reader")
                copyToJava = {
                    "method": "reader_Error",
